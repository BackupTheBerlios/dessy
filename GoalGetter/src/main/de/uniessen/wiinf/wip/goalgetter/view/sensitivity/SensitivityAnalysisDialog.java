...
public final class SensitivityAnalysisDialog extends AbstractDialog {
    ...
    public SensitivityAnalysisDialog(Frame owner, List elements, String nameX,
            String nameY) {
        super(owner, "Sensitivit�tsanalyse", true);
    ...
    protected JComponent buildContent() {
        ...
        FormLayout layout = new FormLayout("right:max(500dlu;p)");
    ...
    private Component buildViewPanel() {
        ...
        FormLayout layout = new FormLayout("right:pref,10dlu,350dlu");//  
        JPanel panel = new JPanel();
        DefaultFormBuilder builder = new DefaultFormBuilder(layout,
                ResourceUtils.getBundle(), panel);
    ...
    private Component buildButtonView() {
        ...
        //		 die combo box
        String[] views = { "2DStackedBarChart", "3DStackedBarChart",
                "2DBarChart", "3DBarChart" };
        ...
        builder.append("Schrittgr��e", stepSizeTextField);
    ...
    private JComponent buildEditFields() {
        ...
        FormLayout layout = new FormLayout(
                "right:pref,5dlu, 50dlu, 5dlu, 25dlu,5dlu,default"); //$NON-NLS-1$
        ...
        while (it.hasNext()) {
            ...
            while (i.hasNext()) {
                ...
                //spin1.setName(String.valueOf(elements.indexOf(se)) + "," +
                // tmp.toString());
        ...
        // preferred size muss immer gr��er ein als die von der scrollpane
    ...
    class SpinnerAction implements ChangeListener {
        ...
        public void stateChanged(ChangeEvent e) {
            if (flag) {
                ...
                ((Map) element.getValues()).put(spName, sp.getValue()
                        .toString());
                sortElements();
                try {
