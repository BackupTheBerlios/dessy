 ...
 * @author Jeff Dinkins
 */
public class GoalGetterFileFilter extends FileFilter {
     ...
     * @see #addExtension
     */
    public GoalGetterFileFilter(String extension) {
        this(extension, null);
    }
     ...
     * @see #addExtension
     */
    public GoalGetterFileFilter(String extension, String description) {
        this();
        if (extension != null)
     ...
     * @see #addExtension
     */
    public GoalGetterFileFilter(String[] filters) {
        this(filters, null);
    }
     ...
     *            extensions to accept
     * @param description
     *            descriptions for the accepted extensions
     * 
     * @see #addExtension
     */
    public GoalGetterFileFilter(String[] filters, String description) {
        this();
     ...
     * 
     * @return extension portion of the file's name
     * @see #getExtension
     ...
     * 
     * @param extension
     *            extension to add to the filter list
     *  
     */
     ...
     * 
     * @param b
     *            whether the extension list (.jpg, .gif, etc) should show up in
     *            the human readable description.
     * 
     * @see #getDescription
     * @see #setDescription
